...
void Field::draw(SDL_Renderer *renderer)
{
    ...
    int centerX = width / 2;
    int centerY = height / 2 + DIFERENCE_SCREEN_FIELD_HEIGHT;
    ...
    SDL_RenderDrawLine(renderer, centerX, DIFERENCE_SCREEN_FIELD_HEIGHT, centerX, height + DIFERENCE_SCREEN_FIELD_HEIGHT);

    // Retângulo esquerdo
    SDL_Rect leftRect = {0, height / 4 + DIFERENCE_SCREEN_FIELD_HEIGHT, rec_width, rec_height};
    SDL_SetRenderDrawColor(renderer, 255, 255, 255, 255);
    ...
    // Retângulo direito
    SDL_Rect rightRect = {width - rec_width, height / 4 + DIFERENCE_SCREEN_FIELD_HEIGHT, rec_width, rec_height};
    SDL_SetRenderDrawColor(renderer, 255, 255, 255, 255);
